...
class Preprocess:
    def __init__(self):
        self.train_file = 'data/mtrain.txt'
        self.test_file = 'data/mtrain.txt'
    ...
    def load_data(self, path):
        ...
        with open(path, 'r') as f:
            ...
            for line in f:
                ...
                cn.append(["BOS"] + word_tokenize(line[1].lower()) + ["EOS"]) # 将中文进行切分， 增加开始与结尾标志
                # " ".join([w for w in line[1]])
                print(en, '\n=======================\n', cn)
                input()
            return en, cn
